...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function PhotosynthesisRate=EPS_Drive(lightinput,CO2input,Tempinput,k1,k2,k3,k4,c1,c2,c3)
...
[Tt,d] = ode15s(@EPS_mb,[0,time],EPS_Con,options1,BF_Param, FI_Param, PS_PR_Param, Sucs_Param,k1,k2,k3,k4,c1,c2,c3);
